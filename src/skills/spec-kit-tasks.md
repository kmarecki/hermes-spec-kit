---
name: spec-kit-tasks
description: Load when the user says 'spec-kit tasks for [feature]', 'speckit tasks for [feature]', 'spec-kit break down [feature]', or 'speckit break down [feature]' — Phase 3 task breakdown.
version: 1.1.0
author: Hermes Agent
license: MIT
